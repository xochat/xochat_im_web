...
import { Channel, ChannelTypeGroup, ChannelTypePerson, XOSDK, Message, MessageContent } from "xochat_js_sdk"
...
export default class MergeforwardContent extends MessageContent {
    ...
    mapToMessage(messageMap: any): Message {
        ...
        let messageContent = XOSDK.shared().getMessageContent(contentType)
