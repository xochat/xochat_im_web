    ...
    render() {
        ...
        if (members && members.length > 0) {
            selectedItems = members.map<MemberSuggestionDataItem>((member) => {
                ...
                item.id = member.uid
                item.icon = XOApp.shared.avatarChannel(new Channel(member.uid, ChannelTypePerson))
        ...
        return (
            <div className="xo-messageinput-box">
                {
                    topView ? <div className="xo-messageinput-box-top">
                        {topView}
                    </div> : undefined
                }

                <div className="xo-messageinput-bar">
                    {/* <div className="xo-messageinput-tabs"></div> */}
                    <div className="xo-messageinput-toolbar">
                        <div className="xo-messageinput-actionbox">
                            {/* <div className="xo-messageinput-actionitem">
                                <div className={clazz("xo-messageinput-sendbtn", hasValue ? "xo-messageinput-hasValue" : null)} onClick={() => {
                                    this.send()
                                }}>
                            ...
                            {/* <div className="xo-messageinput-actionitem" style={{ cursor: "pointer" }} onClick={() => {
                            ...
                            {
                                hideMention ? null : <div className="xo-messageinput-actionitem" style={{ cursor: "pointer" }} onClick={() => {
                                    this.insertText("@")
                                }}>
                    ...
                    >
                        <Mention
                            ...
                            renderSuggestion={(
                                ...
                                return (
                                    <div className={clazz("xo-messageinput-member", focused ? "xo-messageinput-selected" : null)}>
                                        <div className="xo-messageinput-iconbox">
                                            <img alt="" className="xo-messageinput-icon" style={{ width: `24px`, height: `24px`, borderRadius: `24px` }} src={(suggestion as MemberSuggestionDataItem).icon} />
                                        </div>
