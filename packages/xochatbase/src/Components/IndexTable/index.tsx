...
> {
  ...
  sectionUI(indexName: string) {
    ...
    return (
      <div key={indexName} className="xo-indextable-section">
        <div className="xo-indextable-list">
          {items?.map((item, i) => {
            return (
              <div
                key={item.id}
                className="xo-indextable-item"
                onClick={() => {
              ...
              >
                ...
                <div className="xo-indextable-item-content">
                  {canSelect ? (
                    <div className="xo-indextable-checkbox">
                      <Checkbox
                        checked={
                  ...
                  <div className="xo-indextable-item-name">{item.name}</div>
                </div>
              </div>
            );
          })}
          ...
          <div className="xo-indextable-selected-box" id="selectedList">
            {this.getSelectedUsers().map((item) => {
              return (
                <div
                  key={item.id}
                  className="xo-indextable-select-user"
                  onClick={() => {
