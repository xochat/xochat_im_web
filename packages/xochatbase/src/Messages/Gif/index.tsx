    ...
    render() {
        ...
        return <MessageBase message={message} context={context} hiddeBubble={true}>
            <div style={{ width: scaleSize.width, height: scaleSize.height }}>
                <img alt="" src={XOApp.dataSource.commonDataSource.getImageURL(content.url, { width: content.width, height: content.height })} style={{ borderRadius:'5px',width: scaleSize.width, height: scaleSize.height }} />
            </div>
        </MessageBase>
    }
}