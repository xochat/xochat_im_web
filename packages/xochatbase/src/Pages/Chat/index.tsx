    ...
    return (
      <div
        className={classNames(
          ...
          showChannelSetting ? "xo-chat-channelsetting-open" : ""
        )}
      >
        <div className="xo-chat-content-chat">
          <div
            className="xo-chat-conversation-header"
            onClick={() => {
              this.setState({
          ...
          >
            <div className="xo-chat-conversation-header-content">
              <div className="xo-chat-conversation-header-left">
                <div
                  className="xo-chat-conversation-header-back"
                  onClick={(e) => {
                    e.stopPropagation();
                ...
                <div className="xo-chat-conversation-header-channel">
                  ...
                  <div className="xo-chat-conversation-header-channel-info">
                    ...
                    <div className="xo-chat-conversation-header-channel-info-tip"></div>
                  </div>
                </div>
              </div>
              <div className="xo-chat-conversation-header-right">
                {XOApp.endpoints
                  ...
                  .map((item: any, i: number) => {
                    return (
                      <div
                        key={i}
                        className="xo-chat-conversation-header-right-item"
                      >
                        {item}
                      </div>
                    );
                ...
                <div className="xo-chat-conversation-header-right-item">
                  ...
                  <div className="xo-conversation-header-mask"></div>
                </div>
              </div>
            </div>
          </div>
          ...
          return (
            <div className="xo-chat">
              <div
                className={classNames(
                  "xo-chat-content",
                  vm.selectedConversation ? "xo-conversation-open" : undefined
                )}
              >
                <div className="xo-chat-content-left">
                    ...
                    >
                      ...
                      >
                        ...
                        <img
                          src={
                            XOApp.config.themeMode === ThemeMode.dark
                              ? require("./assets/icon_add_dark.png")
                              : require("./assets/icon_add.png")
                          }
                          alt=""
                        />
                      </div>
                  ...
                  <div className="xo-chat-conversation-list">
                    {vm.loading ? (
                      <div className="xo-chat-conversation-list-loading">
                        <Spin style={{ marginTop: "20px" }} />
                      </div>
                    ) : (
                      <ConversationList
                        select={XOApp.shared.openChannel}
...
> {
  ...
  render(): React.ReactNode {
    ...
    return (
      <div className="xo-chatmenuspopover">
        <ul>
          {chatMenus.map((c, i) => {
            return (
              <li
              ...
              >
                ...
                <div className="xo-chatmenuspopover-title">{c.title}</div>
              </li>
            );
          })}
        </ul>
